...
<form form-ajax class="form-horizontal" id="main-form" action="/group/insert">
...
<div class="col-sm-6">
  <div class="form-group">
    ...
    <div class="col-sm-6">
      ...
      <input type="text" class="form-control required" id="inputname" placeholder="组名" name="name">
